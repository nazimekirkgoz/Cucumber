...
public class TestotomasyonuStepdefinitions {
    ...
    public void aramaKutusunaPhoneYazipEnterTusunaBasar() {
    ...
    public void aramaSonucundaUrunBulunamadiginiTestEder() {
        int bulunanSayi = testOtomasyonuPage.bulunanUrunElementleriList.size();
        Assert.assertEquals(0, bulunanSayi);
    }
    ...
    public void passwordOlarakListedeVerilenGirer(String verilenPassword ) {
        testOtomasyonuPage.emailKutusu.sendKeys(verilenPassword);
    }

    @When("email olarak listede verilen {string} girer")
    public void emailOlarakListedeVerilenGirer(String verilenEmail) {
        testOtomasyonuPage.passwordKutusu.sendKeys(verilenEmail);
    }
